...
SWIFT_SOURCES="./Swerver/Helpers/SwiftNonsense.swift ./Swerver/Server/App/Controllers/Resource.swift ./Swerver/Server/Database/Database.swift ./Swerver/Server/HTTP/HTTPServer.swift ./TestApp/Controllers/NotesController.swift ./Swerver/main.swift ./Swerver/Server/App/Models/Model.swift ./Swerver/Server/Database/ModelQuery.swift ./Swerver/Server/HTTP/HTTP.swift ./TestApp/Models/Note.swift ./Swerver/Server/App/Controllers/Controller.swift ./Swerver/Server/Base/TCPServer.swift ./Swerver/Server/HTTP/HTTP11.swift ./Swerver/Server/HTTP/Router.swift"
